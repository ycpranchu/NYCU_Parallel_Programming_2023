...
void workerThreadStart(WorkerArgs *const args)
{
    ...
    float x0 = args->x0, x1 = args->x1;
    float y0 = args->y0, y1 = args->y1;
    ...
    // int totalRows = (height / numThreads) * (threadId + 1);
    ...
    args->record_time[threadId] += endTime - startTime;
}
...
void mandelbrotThread(
    ...
    int maxIterations, int output[], double record_time[])
{
    ...
    for (int i = 0; i < numThreads; i++)
    {
        ...
        args[i].threadId = i;
        args[i].record_time = record_time;
    }
